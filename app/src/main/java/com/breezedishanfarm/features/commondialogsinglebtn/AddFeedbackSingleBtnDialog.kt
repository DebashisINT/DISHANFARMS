package com.breezedishanfarm.features.commondialogsinglebtn
...
import com.breezedishanfarm.app.domain.ShopVisitCompetetorModelEntity
import com.breezedishanfarm.app.domain.VisitRemarksEntity
...
import com.breezedishanfarm.features.addshop.presentation.ProspectListDialog
import com.breezedishanfarm.features.dashboard.presentation.DashboardActivity
import com.breezedishanfarm.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezedishanfarm.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezedishanfarm/files", "recorded_audio${System.currentTimeMillis()}.mp3")

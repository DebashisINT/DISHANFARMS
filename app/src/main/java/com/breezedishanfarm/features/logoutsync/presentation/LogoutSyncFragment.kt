package com.breezedishanfarm.features.logoutsync.presentation
...
import com.breezedishanfarm.CustomConstants


import com.breezedishanfarm.R
import com.breezedishanfarm.app.AppDatabase
...
import com.breezedishanfarm.app.utils.Toaster
import com.breezedishanfarm.base.BaseResponse
import com.breezedishanfarm.base.presentation.BaseActivity
import com.breezedishanfarm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezedishanfarm.features.billing.api.AddBillingRepoProvider
import com.breezedishanfarm.features.billing.model.AddBillingInputParamsModel
...
import com.breezedishanfarm.features.dashboard.presentation.ReasonDialog
...
import com.breezedishanfarm.features.document.model.AddEditDocumentInputParams
import com.breezedishanfarm.features.document.model.DocumentAttachmentModel
...
import com.breezedishanfarm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezedishanfarm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezedishanfarm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezedishanfarm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezedishanfarm.features.orderhistory.model.*
...
import com.breezedishanfarm.features.quotation.model.AddQuotInputModel
import com.breezedishanfarm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezedishanfarm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezedishanfarm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezedishanfarm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezedishanfarm.features.timesheet.model.AddTimeSheetInputModel
import com.breezedishanfarm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezedishanfarm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezedishanfarm.features.viewAllOrder.model.AddOrderInputProductList
import com.breezedishanfarm.mappackage.SendBrod
import com.breezedishanfarm.widgets.AppCustomTextView
import com.breezedishanfarm.MonitorService
import com.breezedishanfarm.MySingleton
import com.breezedishanfarm.app.AlarmReceiver
...
import com.breezedishanfarm.features.addshop.presentation.ShopExtraContactReq
...
import com.breezedishanfarm.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezedishanfarm.features.login.model.GetConcurrentUserResponse
...
import com.breezedishanfarm.features.orderITC.SyncDeleteOpptL
import com.breezedishanfarm.features.orderITC.SyncEditOppt
import com.breezedishanfarm.features.orderITC.SyncOppt
import com.breezedishanfarm.features.orderITC.SyncOpptProductL
import com.breezedishanfarm.features.orderITC.SyncOrd
import com.breezedishanfarm.features.orderITC.SyncOrdProductL
import com.breezedishanfarm.features.performance.model.Gps_status_list
import com.breezedishanfarm.features.performance.model.UpdateGpsInputListParamsModel
import com.breezedishanfarm.features.returnsOrder.ReturnProductList
import com.breezedishanfarm.features.returnsOrder.ReturnRequest
import com.breezedishanfarm.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezedishanfarm.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezedishanfarm/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedishanfarmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedishanfarmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezedishanfarmlogsample/log.zip").path);

package com.breezedishanfarm.features.nearbyshops.presentation
...
import com.breezedishanfarm.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezedishanfarm.app.utils.FTStorageUtils
import com.breezedishanfarm.app.utils.NotificationUtils
...
import com.breezedishanfarm.features.addshop.model.AssignedToShopListResponseModel
import com.breezedishanfarm.features.addshop.model.QuestionSubmit
import com.breezedishanfarm.features.addshop.model.UpdateAddrReq
import com.breezedishanfarm.features.addshop.model.UpdateAddressShop
...
import com.breezedishanfarm.features.addshop.presentation.*
...
import com.breezedishanfarm.features.location.model.ShopDurationRequestData
...
import com.breezedishanfarm.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezedishanfarm.features.marketing.model.MarketingCategoryListResponse
...
import com.breezedishanfarm.features.nearbyshops.model.StageListResponseModel
...
import com.breezedishanfarm.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezedishanfarm.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezedishanfarmApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()

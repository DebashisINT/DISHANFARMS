package com.breezedishanfarm.features.permissionList
...
import com.breezedishanfarm.test.viewPermission.AdapterViewPermission
        ...
        for(i in 0..list.size-1){
            if(list1.get(i)!="android.permission.ACCESS_GPS") {
                var obj: PermissionDetails = PermissionDetails(list1.get(i).replace("android.permission.", "").replace("_", " ")
                        ...
                        replace("com.breezedishanfarm.permission.C2D",""), list.get(i))
